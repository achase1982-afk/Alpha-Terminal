...
**web_search** uses the dedicated Web Search API when WEB_SEARCH_API_KEY is set (with optional WEB_SEARCH_API_FALLBACK_KEY); otherwise your chat model's provider-native search (Claude, Gemini, or OpenAI).`;
}
