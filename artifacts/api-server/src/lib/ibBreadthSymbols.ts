...
export const ALL_BREADTH_SYMBOLS: IBSymbolDef[] = [
  ...
  { reqId: 5058, symbol: "$PCUSEQTR", ibSymbol: "PCUSEQTR", secType: "IND", exchange: "CBOE",    displaySymbol: "$PCUSEQTR", category: "PUT_CALL", description: "CBOE Equity Put/Call Ratio",           enabled: false, sourceField: "bid" },
  { reqId: 5059, symbol: "$PCUSINXR", ibSymbol: "PCUSINXR", secType: "IND", exchange: "CBOE",    displaySymbol: "$PCUSINXR", category: "PUT_CALL", description: "CBOE Index Put/Call Ratio",            enabled: false, sourceField: "bid" },
