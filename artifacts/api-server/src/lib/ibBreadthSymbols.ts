...
export const ALL_BREADTH_SYMBOLS: IBSymbolDef[] = [
  ...
  { reqId: 5054, symbol: "$PCSPY",  ibSymbol: "PCSPY",      secType: "IND", exchange: "CBOE",    displaySymbol: "$PCSPY",  category: "PUT_CALL", description: "SPY Put/Call Ratio — SPY-specific options sentiment",           enabled: true },
