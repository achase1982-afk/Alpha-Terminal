...
export const ALL_BREADTH_SYMBOLS: IBSymbolDef[] = [
  ...
  { reqId: 5055, symbol: "$PCQQQ",  ibSymbol: "PCQQQ",      secType: "IND", exchange: "CBOE",    displaySymbol: "$PCQQQ",  category: "PUT_CALL", description: "QQQ Put/Call Ratio — QQQ-specific options sentiment",           enabled: true },
  { reqId: 5056, symbol: "$PCIWM",  ibSymbol: "PCIWM",      secType: "IND", exchange: "CBOE",    displaySymbol: "$PCIWM",  category: "PUT_CALL", description: "IWM Put/Call Ratio — IWM-specific options sentiment",           enabled: true },
