...
export const ALL_BREADTH_SYMBOLS: IBSymbolDef[] = [
  ...
  { reqId: 5121, symbol: "/BZ",     ibSymbol: "COIL",       secType: "FUT", exchange: "IPE",     displaySymbol: "/BZ",     category: "COMMODITY", description: "Brent Crude Oil Future (ICE Futures Europe — needs ICE subscription; use Schwab WS instead)", enabled: false },
