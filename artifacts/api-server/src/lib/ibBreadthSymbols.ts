...
export const ALL_BREADTH_SYMBOLS: IBSymbolDef[] = [
  ...
  // ═══════════════════════════════════════════════════════════
  { reqId: 5050, symbol: "$CPC",    ibSymbol: "CPC",        secType: "IND", exchange: "CBOE",    displaySymbol: "$CPC",    category: "PUT_CALL", description: "CBOE Total Put/Call Ratio — not available via IB",              enabled: false },
  { reqId: 5051, symbol: "$CPCE",   ibSymbol: "CPCE",       secType: "IND", exchange: "CBOE",    displaySymbol: "$CPCE",   category: "PUT_CALL", description: "CBOE Equity Put/Call Ratio — not available via IB",             enabled: false },
  ...
  // ═══════════════════════════════════════════════════════════
  { reqId: 5052, symbol: "$CPCI",   ibSymbol: "CPCI",       secType: "IND", exchange: "CBOE",    displaySymbol: "$CPCI",   category: "PUT_CALL", description: "CBOE Index Put/Call Ratio — not available via IB",              enabled: false },
  { reqId: 5053, symbol: "$PCALL",  ibSymbol: "PCALL",      secType: "IND", exchange: "CBOE",    displaySymbol: "$PCALL",  category: "PUT_CALL", description: "CBOE Total Put/Call Volume — not available via IB",             enabled: false },
  { reqId: 5054, symbol: "$PCSPY",  ibSymbol: "PCSPY",      secType: "IND", exchange: "CBOE",    displaySymbol: "$PCSPY",  category: "PUT_CALL", description: "SPY Put/Call Ratio — not available via IB",                     enabled: false },
  { reqId: 5055, symbol: "$PCQQQ",  ibSymbol: "PCQQQ",      secType: "IND", exchange: "CBOE",    displaySymbol: "$PCQQQ",  category: "PUT_CALL", description: "QQQ Put/Call Ratio — not available via IB",                     enabled: false },
  { reqId: 5056, symbol: "$PCIWM",  ibSymbol: "PCIWM",      secType: "IND", exchange: "CBOE",    displaySymbol: "$PCIWM",  category: "PUT_CALL", description: "IWM Put/Call Ratio — not available via IB",                     enabled: false },
  { reqId: 5057, symbol: "$PCVIX",  ibSymbol: "PCVIX",      secType: "IND", exchange: "CBOE",    displaySymbol: "$PCVIX",  category: "PUT_CALL", description: "VIX Put/Call Ratio — not available via IB",                     enabled: false },
