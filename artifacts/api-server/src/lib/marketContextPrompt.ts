...
- If session is PREMARKET or AFTERHOURS: equity prints can still update on the live tape; use displayLast when present. Caveat thin volume vs regular hours when relevant.
- If session is CLOSED (after ~8 PM ET until premarket): latest prints may be stale; say so if quote age is high.
