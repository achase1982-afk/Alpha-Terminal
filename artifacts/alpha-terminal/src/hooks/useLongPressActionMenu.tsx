...
/** Anchor at bottom-center of the message bubble (menu opens below the text). */
export function longPressMenuAnchorBelow(el: HTMLElement): { x: number; y: number } {
    ...
    (getAnchor?: (el: HTMLElement) => { x: number; y: number }) => ({
      onPointerDown: (e: React.PointerEvent<HTMLElement>) => {
        ...
        timerRef.current = setTimeout(() => {
          ...
          const pos = getAnchor
            ? getAnchor(target)
            : longPressMenuAnchorBelow(target);
          setAnchor(pos);
          setOpen(true);
        }, LONG_PRESS_MS);
      },
      ...
      onContextMenu: (e: React.MouseEvent) => {
        ...
        setAnchor(
          getAnchor ? getAnchor(target) : longPressMenuAnchorBelow(target),
        );
        setOpen(true);
      },
    }),
