...
function decisionColor(decision: string, placed: boolean): string {
  ...
  if (decision === "TAKE_PROFIT" || decision === "PROFIT_LOCK") return "#2ecc71";
  if (decision === "SELL" || decision === "FLATTEN_CLOSE" || decision === "EXIT" || decision === "STOP_EXIT" || decision === "STOP_LOSS") return "#f23645";
