...
export function ScannerChromeBar({ universeSlot, scanSlot, footerSlot }: ScannerChromeBarProps) {
  return (
    <div className="sticky top-0 z-20 w-full border-b border-zinc-800/50 bg-[#0c0c0c] py-2 pl-[max(1rem,env(safe-area-inset-left,0px))] pr-[max(1rem,env(safe-area-inset-right,0px))] sm:pl-5 sm:pr-6">
