          ...
          >
            ...
            >
              <div className={`prose prose-sm max-w-none font-light ${
                msg.role === "user"
                  ? "prose-invert prose-p:text-primary-foreground prose-p:text-[15px] prose-li:text-[15px] prose-li:text-primary-foreground"
                  : "prose-invert prose-p:text-gray-200 prose-p:text-[15px] prose-li:text-[15px] prose-li:text-gray-200"
              } prose-p:leading-relaxed prose-p:my-1 prose-pre:text-[13px] prose-code:text-primary prose-a:text-primary
                prose-headings:text-[16px] prose-headings:font-light prose-headings:text-foreground prose-strong:font-normal prose-strong:text-white`}>
