    ...
    return (
      <div className="rounded-xl border border-[#FFB800]/30 p-4">
        <div className="flex items-center gap-2 mb-2">
          ...
          <span className="font-mono text-xs font-light text-[#FFB800]">NO EDGE</span>
        </div>
  ...
  return (
    <div className="space-y-3">
      <div className="flex items-center gap-2 px-1">
        <Crosshair className="w-4 h-4 text-[#FFB800]" />
        <span className="font-mono text-xs font-light text-[#e4e4e7] tracking-wider">ACTION PLAN</span>
      </div>
      {items.map((item, i) => (
        <div key={i} className="rounded-xl border border-[#2A2A2C] overflow-hidden" style={{ background: "#111113" }}>
          <div className="p-4 space-y-3">
            <div className="font-mono text-xs text-[#FFB800] font-light">{item.condition}</div>
            ...
            <div className="flex items-center gap-2">
              <span
                className="px-2 py-0.5 rounded-full font-mono text-[9px] font-light tracking-wider"
                style={{
