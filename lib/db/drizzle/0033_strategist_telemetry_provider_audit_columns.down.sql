...
BEGIN
  IF EXISTS (
    ...
    ALTER TABLE public.strategist_telemetry RENAME COLUMN provider_request_id TO anthropic_request_id;
  END IF;
END $$;
...
BEGIN
  IF EXISTS (
    ...
    ALTER TABLE public.strategist_telemetry RENAME COLUMN thinking_config TO extended_thinking_config;
  END IF;
END $$;

ALTER TABLE public.strategist_telemetry DROP COLUMN IF EXISTS provider;
